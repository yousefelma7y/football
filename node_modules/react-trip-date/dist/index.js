...
var DisplayMonths = function (_a) {
    ...
    var renderMonths = function () {
        ...
        return months.map(function (item) {
            return (jsxRuntime.jsx("div", __assign({ onClick: function () { return selectMonth(item); }, "data-testid": "month-item-to-select" }, { children: jsxRuntime.jsx("p", { children: item.format("MMMM") }, void 0) }), item.format("MM-MMMM")));
        });
    };
    return jsxRuntime.jsx(Wrapper$5, __assign({ jalali: jalali }, { children: renderMonths() }), void 0);
};
var Wrapper$5 = styled__default['default'].div(templateObject_1$5 || (templateObject_1$5 = __makeTemplateObject(["\n  margin-top: 15px;\n  display: flex;\n  flex: 1 1;\n  height: 350px;\n  flex-wrap: wrap;\n  flex-direction: ", ";\n  > div {\n    flex-basis: calc(25% - 4px);\n    justify-content: center;\n    text-align: center;\n    display: flex;\n    background-color: ", ";\n    align-items: center;\n    cursor: pointer;\n    border: 2px solid #fff;\n    p {\n      color: #fff;\n    }\n  }\n"], ["\n  margin-top: 15px;\n  display: flex;\n  flex: 1 1;\n  height: 350px;\n  flex-wrap: wrap;\n  flex-direction: ",
    ";\n  > div {\n    flex-basis: calc(25% - 4px);\n    justify-content: center;\n    text-align: center;\n    display: flex;\n    background-color: ", ";\n    align-items: center;\n    cursor: pointer;\n    border: 2px solid #fff;\n    p {\n      color: #fff;\n    }\n  }\n"])), function (_a) {
...
var Header = function (_a) {
    ...
    var renderTitles = function () {
        ...
        var titles = [];
        if (displayMonths) {
            return (jsxRuntime.jsx("p", __assign({ onClick: function () { return setDisplayMonths(function (prev) { return !prev; }); } }, { children: source.format(((_a = components === null || components === void 0 ? void 0 : components.header) === null || _a === void 0 ? void 0 : _a.format)
        ...
        for (var i = 0; i < numberOfMonths; i++) {
            ...
            titles.push(jsxRuntime.jsx("p", __assign({ onClick: function () { return setDisplayMonths(function (prev) { return !prev; }); } }, { children: source
                    .add(i, "month")
    ...
    return (jsxRuntime.jsxs(Wrapper$4, __assign({ numberOfMonths: numberOfMonths, jalali: jalali, displayMonths: displayMonths }, { children: [jsxRuntime.jsxs("div", __assign({ className: ((_c = (_b = components === null || components === void 0 ? void 0 : components.header) === null || _b === void 0 ? void 0 : _b.monthIcons) === null || _c === void 0 ? void 0 : _c.left) ? "" : "action left", onClick: prev }, { children: [((_e = (_d = components === null || components === void 0 ? void 0 : components.header) === null || _d === void 0 ? void 0 : _d.monthIcons) === null || _e === void 0 ? void 0 : _e.left) &&
                    ...
                    !((_j = (_h = components === null || components === void 0 ? void 0 : components.header) === null || _h === void 0 ? void 0 : _h.monthIcons) === null || _j === void 0 ? void 0 : _j.left) && (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(SvgChevronLeft, {}, void 0),
                            displayMonths ? jsxRuntime.jsx(SvgChevronLeft, {}, void 0) : null] }, void 0))] }), void 0), renderTitles(), jsxRuntime.jsxs("div", __assign({ className: ((_l = (_k = components === null || components === void 0 ? void 0 : components.header) === null || _k === void 0 ? void 0 : _k.monthIcons) === null || _l === void 0 ? void 0 : _l.right) ? "" : "action right", onClick: next }, { children: [((_o = (_m = components === null || components === void 0 ? void 0 : components.header) === null || _m === void 0 ? void 0 : _m.monthIcons) === null || _o === void 0 ? void 0 : _o.right) &&
                        !displayMonths &&
                    ...
                    !((_s = (_r = components === null || components === void 0 ? void 0 : components.header) === null || _r === void 0 ? void 0 : _r.monthIcons) === null || _s === void 0 ? void 0 : _s.right) && (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(SvgChevronRight, {}, void 0),
                            displayMonths ? jsxRuntime.jsx(SvgChevronRight, {}, void 0) : null] }, void 0))] }), void 0)] }), void 0));
};
var Wrapper$4 = styled__default['default'].div(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  height: 55px;\n  position: relative;\n  background-color: ", ";\n  flex-direction: ", ";\n  p {\n    color: #fff;\n    text-align: center;\n    cursor: pointer;\n    direction: ", ";\n    width: ", ";\n  }\n  .action {\n    position: absolute;\n    height: 55px;\n    width: 55px;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    cursor: pointer;\n    &.right {\n      transform: ", ";\n      ", "\n    }\n    &.left {\n      transform: ", ";\n      ", "\n    }\n  }\n  svg {\n    width: 10px;\n    height: 15px;\n    color: ", ";\n  }\n"], ["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  height: 55px;\n  position: relative;\n  background-color: ", ";\n  flex-direction: ", ";\n  p {\n    color: #fff;\n    text-align: center;\n    cursor: pointer;\n    direction: ", ";\n    width: ",
    ";\n  }\n  .action {\n    position: absolute;\n    height: 55px;\n    width: 55px;\n    display: flex;\n    align-items: center;\n    justify-content: center;\n    cursor: pointer;\n    &.right {\n      transform: ",
    ";\n      ", "\n    }\n    &.left {\n      transform: ",
    ";\n      ", "\n    }\n  }\n  svg {\n    width: 10px;\n    height: 15px;\n    color: ", ";\n  }\n"])), function (_a) {
    var theme = _a.theme;
...
var Wrapper$3 = styled__default['default'].div(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  position: relative;\n  flex-direction: ", ";\n"], ["\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  position: relative;\n  flex-direction: ", ";\n"])), function (_a) {
    var jalali = _a.jalali;
    return (jalali ? "row-reverse" : "row");
});
var Month = styled__default['default'].div(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n  height: 350px;\n  display: flex;\n  position: relative;\n  align-items: center;\n  flex-direction: column;\n  width: ", ";\n"], ["\n  height: 350px;\n  display: flex;\n  position: relative;\n  align-items: center;\n  flex-direction: column;\n  width: ", ";\n"])), function (_a) {
    var numberOfMonths = _a.numberOfMonths;
    return 100 / numberOfMonths + "%";
});
var Weeks = styled__default['default'].div(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n  display: flex;\n  align-items: center;\n  position: relative;\n  flex-direction: ", ";\n"], ["\n  display: flex;\n  align-items: center;\n  position: relative;\n  flex-direction: ", ";\n"])), function (_a) {
    var jalali = _a.jalali;
    return (jalali ? "row-reverse" : "row");
});
...
var TitleOfWeek = function (_a) {
    ...
    if (components === null || components === void 0 ? void 0 : components.wrapper) {
        ...
        return jsxRuntime.jsx(WrapperC, { jalali: jalali, startOfWeek: startOfWeek }, void 0);
    }
    return (jsxRuntime.jsx(Wrapper$2, __assign({ jalali: jalali, startOfWeek: startOfWeek }, { children: titles.map(function (item) { return (jsxRuntime.jsx("p", { children: item }, item)); }) }), void 0));
};
var Wrapper$2 = styled__default['default'].div(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  display: flex;\n  text-align: center;\n  justify-content: center;\n  flex-direction: ", ";\n  border-bottom: 1px solid #e2e2e2;\n  margin: 30px 0 15px 0;\n  p {\n    width: 38px;\n    margin-bottom: 15px;\n    margin-left: 5px;\n  }\n"], ["\n  display: flex;\n  text-align: center;\n  justify-content: center;\n  flex-direction: ", ";\n  border-bottom: 1px solid #e2e2e2;\n  margin: 30px 0 15px 0;\n  p {\n    width: 38px;\n    margin-bottom: 15px;\n    margin-left: 5px;\n  }\n"])), function (_a) {
    var jalali = _a.jalali;
    return (jalali ? "row-reverse" : "row");
});
...
var Day$1 = function (_a) {
    ...
    return (jsxRuntime.jsxs(Wrapper$1, __assign({ "data-test": day.format(FORMAT_DATE), onClick: onClick, onMouseEnter: hoverOnDay, className: classNames({
        ...
        }) }, { children: [DayComponent && (jsxRuntime.jsx(DayComponent, { day: day.format(FORMAT_DATE), jalali: jalali }, void 0)), !DayComponent && day.format("DD")] }), void 0));
};
...
var Months$1 = function (_a) {
    ...
    var renderMonths = function () {
        ...
        var _loop_1 = function (i) {
            ...
            months.push(jsxRuntime.jsxs(Month, __assign({ numberOfMonths: numberOfMonths || 1, "data-test": dayjs().set("month", 1).set("day", 1).diff(source, "d") }, { children: [jsxRuntime.jsx(TitleOfWeek, { jalali: jalali, startOfWeek: startOfWeek, components: components === null || components === void 0 ? void 0 : components.titleOfWeek }, void 0),
                    weeksDays.map(function (week) { return (jsxRuntime.jsx(Weeks, __assign({ jalali: jalali, "data-test": dayjs()
                            .set("month", 1)
                            .set("day", 1)
                            .diff(week[0], "d") }, { children: week.map(function (day) { return (jsxRuntime.jsx(Day$1, { day: day, jalali: jalali, numberOfMonth: i, hoverDay: hoverDay, setHoverDay: setHoverDay, onChange: onChange, components: components, source: sourceProp, disabled: disabled, disabledDays: disabledDays, selectedDays: selectedDays, setSelectedDays: setSelectedDays, disabledBeforeToday: disabledBeforeToday, allowDisabledDaysSpan: allowDisabledDaysSpan, disabledBeforeDate: disabledBeforeDate, disabledAfterDate: disabledAfterDate }, day.format("YYYY-MM-DD"))); }) }), dayjs().set("month", 1).set("day", 1).diff(week[0], "d"))); })] }), dayjs().set("month", 1).set("day", 1).diff(source, "d")));
        };
        for (var i = 0; i < numberOfMonths; i++) {
            _loop_1(i);
        }
    ...
    return jsxRuntime.jsx(Wrapper$3, __assign({ jalali: jalali }, { children: renderMonths() }), void 0);
};
...
var RangePicker = function (_a) {
    ...
    var _k = React.useState(selectedDaysProps), selectedDays = _k[0], setSelectedDays = _k[1];
    var _l = React.useState(), hoverDay = _l[0], setHoverDay = _l[1];
    var _m = React.useState(false), displayMonths = _m[0], setDisplayMonths = _m[1];
    var _o = React.useState(dayjsLocalized(jalali, initialMonthAndYear)), source = _o[0], setSource = _o[1];
    var _p = React.useState(numberOfMonthsProps), numberOfMonths = _p[0], setNumberOfMonths = _p[1];
...
var Day = function (_a) {
    ...
    var DayComponent = components === null || components === void 0 ? void 0 : components.days;
    return (jsxRuntime.jsxs(Wrapper, __assign({ "data-test": day.format(FORMAT_DATE), onClick: handleClick, className: classNames({
            inactive: day.month() !== source.add(numberOfMonth, "month").month(),
...
var Months = function (_a) {
    ...
    var renderMonths = function () {
        ...
        var _loop_1 = function (i) {
            ...
            months.push(jsxRuntime.jsxs(Month, __assign({ numberOfMonths: numberOfMonths || 1, "data-test": dayjs_min().set("month", 1).set("day", 1).diff(source, "d") }, { children: [jsxRuntime.jsx(TitleOfWeek, { jalali: jalali, startOfWeek: startOfWeek, components: components === null || components === void 0 ? void 0 : components.titleOfWeek }, void 0),
                    weeksDays.map(function (week) { return (jsxRuntime.jsx(Weeks, __assign({ jalali: jalali, "data-test": dayjs_min()
                            .set("month", 1)
                            .set("day", 1)
                            .diff(week[0], "d") }, { children: week.map(function (day) { return (jsxRuntime.jsx(Day, { day: day, jalali: jalali, numberOfMonth: i, disabled: disabled, onChange: onChange, source: sourceProp, components: components, disabledDays: disabledDays, selectedDays: selectedDays, setSelectedDays: setSelectedDays, disabledBeforeToday: disabledBeforeToday, disabledBeforeDate: disabledBeforeDate, disabledAfterDate: disabledAfterDate, numberOfSelectableDays: numberOfSelectableDays }, day.format("YYYY-MM-DD"))); }) }), dayjs_min().set("month", 1).set("day", 1).diff(week[0], "d"))); })] }), dayjs_min().set("month", 1).set("day", 1).diff(source, "d")));
        };
        for (var i = 0; i < numberOfMonths; i++) {
            _loop_1(i);
        }
...
var DatePicker = function (_a) {
    ...
    var _k = React.useState(selectedDaysProps || []), selectedDays = _k[0], setSelectedDays = _k[1];
    var _l = React.useState(numberOfMonthsProps), numberOfMonths = _l[0], setNumberOfMonths = _l[1];
    var _m = React.useState(false), displayMonths = _m[0], setDisplayMonths = _m[1];
    var _o = React.useState(dayjsLocalized(jalali, initialMonthAndYear)), source = _o[0], setSource = _o[1];
    React.useEffect(function () {
        if (onRangeDateInScreen) {
